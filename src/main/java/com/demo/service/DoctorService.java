...
public class DoctorService {
    ...
    public void updateUserInfor(Doctor doctor) {
        ...
        doctorDao.updateDocInf(doctor.getDoctorName(),doctor.getSex(),doctor.getBirthday(),
                ...
                doctor.getGraSchool(),doctor.getDepartment(),doctor.getDoctorId(),doctor.getHeadAdd());
   ...
   //医生回复线上咨询问诊单
     ...
     * 插入服务记录
     */
    public void insertDocMission(int doctorId,int userId,String rectime) {
        doctorDao.insertDocMission(doctorId,userId,rectime);
    }

//    public void updateState(int inquiryId) {
//        doctorDao.updateState(inquiryId);
//
//    }
}
