...
public interface IDoctorSerDao {
    ...
    void updateDocInf(@Param("doctorName") String doctorName, @Param("sex") String sex, @Param("birthday") String birthday,
                      ...
                      @Param("doctorId") int doctorId, @Param("headAdd") String headAdd);
    ...
    void insertDocMission(@Param("doctorId") int doctorId, @Param("userId") int userId, @Param("recTime") String recTime);
