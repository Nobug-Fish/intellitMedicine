...
<div class="head" >
    ...
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px;padding-left: 30px">我的咨询记录列表  &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp; &nbsp; &nbsp; <a  href="/userHome.do" style="padding-right: 90px;color: white">用户首页</a> <a  style="padding-right:200px;color: white" href="/userExit.do">退出登录</a></p>
    <%--                <p style="text-align:right;font-size: 45px;color: white;padding-right: 30px">  <a href="/userAskRec.do" target="abc">我的咨询记录</a></p>--%>
</div>
<hr>
