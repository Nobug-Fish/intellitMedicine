...
<body>
<div class="head">
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px">养老机构管理平台</p>
</div>
...
<div class="row">
    <div class="left" style="background-color:#337ab7;">
        <ul id="myMenu">
            <li><input type="button" id="v1" value="新增机构" onclick="v1show()"></li>
            <li><input type="button" id="v2" value="管理机构" onclick="v2show()"></li>
        </ul>
    </div>
    <div class="right">
        <hr>
        <div class="medium21" id="div1">
            ...
            <form id="medicineInformation" style="border: black 1px solid;width: 500px;margin-top: 20px" method="post">
                <ul>
                    <li>
                        机构名称：<input type="text" id="name" name="name">
                    </li>
                    <li>
                        机构简介：<br><textarea name="area" id="area" cols="30" rows="5" style="font-size: 20px"
                                           placeholder="请依次输入联系方式、位置信息、机构简介，形如“联系方式,位置信息,机构简介”"></textarea>
                    </li>
                    <button class="div_btn1" onclick="b();">提交</button>
                </ul>
            </form>
        </div>
        <div class="medium22" id="div2">
            ...
            <div class="medium1">
                <form id="search" name="search" method="post">
                    <input type="text" name="pname" id="pname" placeholder="请输入养老机构名称" style="font-size: 20px"/>
                </form>
    ...
    function refreshTable(page) {
        ...
        List.forEach(function (data) {
            ...
            var htmlStr = "<tr style='padding: 10px'>" +
                "<td><h5> " + data.pensionId + "</h5> </td>" +
                "<td>" + data.pensionName + "</td>" +
                ...
                "<label style='text-align: center;width: 40px;height:20px '>简介："+array[2]+"</label><br/></td>" +
                "<td><button class='div_btn' onclick='newDelete(" + data.pensionId + ")'>删除机构</button></td>" +
                "</tr>";
