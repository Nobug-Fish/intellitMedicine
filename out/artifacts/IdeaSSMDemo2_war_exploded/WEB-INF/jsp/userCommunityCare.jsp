...
<body>
<div class="title">
    <p style="margin-left: 2%;text-align:left;font-size: 45px;color: white;padding-top: 20px">社区养老</p>
</div>
<form method="post">
...
<script type="application/javascript">
    ...
    function refreshTable(page) {
        ...
        List.forEach(function (data) {
            ...
            var htmlStr = "<tr>" +
                "<td><img src='' height='10px' width='10px'><h5> " + data.comName + "</h5> </td>" +
                ...
                "<label style='text-align: center;width: 40px;height:20px '>简介：" + array[2] + "</label>" +
                "<td/>" +
                "</tr>";
