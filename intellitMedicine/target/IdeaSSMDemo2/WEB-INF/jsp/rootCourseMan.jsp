...
<div class="head">
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px;margin-left: 3%">教育管理平台
        &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
        <a href="/rootHome.do" style="color: white;font-size: xx-large;">管理员首页</a>  &nbsp;&nbsp; <a href="/rootExit.do" style="color: white;font-size: xx-large;">退出登录</a>
    </p>
</div>
<div class="row">
