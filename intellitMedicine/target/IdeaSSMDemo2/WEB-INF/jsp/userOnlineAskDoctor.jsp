...
<div class="head" style="padding-left: 1%;width: 60%;align-content: center;margin-left: 20%;margin-top: 10px">
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px">在线咨询:&nbsp;&nbsp;<span style="color: white "> ${askDoctor.doctorName}医生</span></p>
</div>
<hr >
                ...
                <div class="form-upload-opreate clearfix">
                    <ul class="form-upload-list"></ul>
                        <div class="" id="upload" >
                            ...
                            <p class="">添加图片 <span>(可选填),可添加检查单，请保证图片清晰</span></p>
                        </div>
                    </div>
                </div>
