...
<div class="left" id="upload" style="margin-bottom: 2%">
    <img  src="${user.headAdd}"  onclick="imgClick()" style="height: 40%;width:40%;">
</div>
<div class="right">
    <ul>
...
<%--        </li>--%>
    ...
    <div class="block">
        <input type="submit" id="change" value="修改" style="width: 200px; height: 30px;font-size: 20px;">
    </div>
</div>
</form>
<script>
    ...
    function HeadPortUpload(fileObj){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("headAdd").val(data)
                // $("#headPort").val(data);
                $("#upload").html("<img style=\"height: 40%;width:40%;margin-bottom: 20px\" src='"+data+"' width='200px' onclick='imgClick()'>");
            },
            error: function () {
                alert("上传失败！");
            }
