...
<script type="application/javascript">
    ...
    function videoOpen(url_0) {

        document.getElementById('light').style.display = 'block';
        document.getElementById('fade').style.display = 'block';

        var htmlstr = "<video id='video_1' src='"+url_0+"' width='100%' height='90%' controls='controls'></video>";
        $("#light").append(htmlstr);
    }
    ...
    function refreshTable(page) {
        ...
        courseList.forEach(function (course) {
            ...
            var htmlStr = "<tr>" +
                ...
                "<td width=\"50px\" height=\"10px\"><button  onclick='videoOpen(\"" + course.courseAdd + "\")'> 视频播放 </button></td>"
            "</tr>";
