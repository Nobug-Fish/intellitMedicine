...
<div class="head">
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px;padding-left: 2%">医生信息管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="span12  center-block" id="div1">
            <div style="margin-top: 2%">
                ...
                <div class="text-center">
                    ...
                    <span class="control-label" id="showInfo1" style="color: #08ff06"> 第 1 页 / 共 1 页 </span>
