...
<%--    <form class="form-horizontal" action="userRegister.do" method="post">--%>
<%--        <div class="form-group">--%>
<%--            <label class="col-sm-3 control-label">用户注册</label>--%>
<%--        </div>--%>
<%--        <div class="div1">--%>
<%--        </div><br>--%>
<%--        <div class="form-group">--%>
...
<%--            <div class="col-sm-10">--%>
<%--                <input type="text" id="name" name="userName" class="form-control" placeholder="输入用户名">--%>
<%--            </div>--%>
<%--            <label for="name" id="accountCheakStart" class="control-label"></label>--%>
<%--        </div>--%>
<%--        <div class="form-group">--%>
...
<%--            <label class="col-sm-3 control-label">所在社区</label>--%>
<%--            <div class="col-sm-10">--%>
<%--                <input type="text" id="community" name="community" class="form-control" placeholder="输入社区">--%>
<%--            </div>--%>
<%--        </div>--%>
<%--        <div class="form-group" >--%>
