...
<body>
<div class="head">
    <p style="text-align:left;font-size: 45px;color: white;padding-top: 20px;margin-left: 2%">社区管理平台</p>
</div>
        ...
        <div class="medium21" id="div1">
            ...
            <form id="medicineInformation" style="border: black 1px solid;width: 500px;margin-top: 20px" method="post">
                <ul>
                    ...
                    <li>
                        社区简介：<br><textarea name="area" id="area" cols="30" rows="5" style="font-size: 20px"
